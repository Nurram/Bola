...
class TeamRecyclerAdapter(
    ...
    private val teams: List<TeamList>,
    private val listener: (TeamList) -> Unit
) : RecyclerView.Adapter<TeamRecyclerAdapter.RecyclerHolder>() {
    ...
    inner class RecyclerHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView),
        ...
        fun bind(team: TeamList, listener: (TeamList) -> Unit) {
